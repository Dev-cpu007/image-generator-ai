    ...
    <header className="w-full py-4 sm:py-5 px-4 sm:px-8 md:px-16 flex flex-wrap justify-between items-center shadow-sm">
      ...
      <div className="flex items-center space-x-2">
        <span className="inline-block bg-[#3885ff] rounded-lg p-2">
          {/* <!-- Logo --> */}
          <svg onClick={()=>navigate('/home')} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span onClick={()=>navigate('/home')}  className="text-xl sm:text-2xl font-bold text-black cursor-default ">Kalpana-AI</span>
      </div>
      ...
      <nav id="mobile-nav" className="w-full md:hidden bg-white">
        <div className="flex flex-col space-y-3 py-3">
          <a onClick={()=>navigate('/buy')} className="text-gray-700 text-sm hover:underline p-2 cursor-default">Pricing</a>
      ...
      <nav className="hidden md:flex items-center space-x-4 lg:space-x-2">
        <a onClick={()=>navigate('/buy')} className="text-gray-700 text-sm lg:text-base hover:underline p-2 cursor-default">Pricing</a>
